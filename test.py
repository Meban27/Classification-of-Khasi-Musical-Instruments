...
def extract_instrument_name(file_name):
    # Extract instrument name from the file name, neglecting all the integers and combine all the letters left
...
# Apply the mapping to a new Instrument_mapping column and create a new column
    ...
    # Save the DataFrame to an Excel file// you can save it to csv or database
    df.to_excel('the/name/you/want/to/give/toyour/excel', index=False)
